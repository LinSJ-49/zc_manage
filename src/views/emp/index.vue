...
//职位列表数据
const jobs = ref([{ name: '辅导员', value: 1 },{ name: '教导主任', value: 2 },{ name: '授课教师', value: 3 },{ name: '教研主管', value: 4 },{ name: '教学秘书', value: 5 },{ name: '其他', value: 6 }])
//性别列表数据
...
const handleDelete = async (id) => {
  //弹出一个确认框, 如果确认, 就删除;
  ElMessageBox.confirm('确定删除该员工教师吗?', '提示', {
...
const deleteByIds = async () => {
  //弹出一个确认框, 如果确认, 就删除;
  ElMessageBox.confirm('确定删除选中员工教师吗?', '提示', {
    confirmButtonText: '确定',
    cancelButtonText: '取消',
    type: 'warning'
  }).then(async () => {
...
<template>
  ...
  <el-form :inline="true" :model="searchEmp">
    <el-form-item label="姓名">
      <el-input v-model="searchEmp.name" placeholder="请输入员工教师姓名"></el-input>
    </el-form-item>
  ...
  <el-button type="primary" @click="addEmp"> + 新增员工教师</el-button>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="用户名" prop="username">
              <el-input v-model="employee.username" placeholder="请输入员工教师用户名，2-20个字"></el-input>
            </el-form-item>
          </el-col>
          
          <el-col :span="12">
            <el-form-item label="姓名" prop="name">
              <el-input v-model="employee.name" placeholder="请输入员工教师姓名，2-10个字"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="手机号" prop="phone">
              <el-input v-model="employee.phone" placeholder="请输入员工教师手机号"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="薪资" prop="salary">
              <el-input v-model="employee.salary" placeholder="请输入员工教师薪资"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
